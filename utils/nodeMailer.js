                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <td style="padding: 20px 0 30px 0; text-align: center;">
                            <p style="color: #666666;">You have requested to reset your password. Click the link below to reset your password:</p>
                             <p>
                              <a href="${process.env.FRONTEND_URL_PROD}/reset-password/${user.resetPasswordToken}?mail=${user.email}" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Reset Password</a>
                            </p>
                        </td>
                        </tr>
                    </table>
  ...
  try {
    ...
    switch (id) {
      ...
      case mailOptions.shippingConfirmation:
        mailInfo = {
          ...mailInfo,
          ...templates.shippingConfirmation(
            "Customer Name",
            "#12334",
            "shiprocket",
            "12345",
